...
namespace FluxIliasRestApi\Service\GroupMember;
...
ORDER BY object_data.obj_id ASC,object_data_user.obj_id ASC,object_reference.ref_id ASC";
    ...
    private function mapGroupMemberDiff(GroupMemberDiffDto $diff, int $user_id, ilObjGroup $ilias_group) : void
    {
        ...
        if ($roles[InternalGroupMemberType::ADMINISTRATOR->value]) {
            ...
            $ilias_group->getMembersObject()
                ->updateNotification($user_id, $diff->notification !== null ? $diff->notification : $ilias_group->getMembersObject()->isNotificationEnabled($user_id));
        } else {
