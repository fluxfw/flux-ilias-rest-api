...
class UpdateObjectByImportIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Update object in object by import id",
            null,
            [
    ...
    {
        return "/object/by-import-id/{import_id}/update";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_rest_api->updateObjectByImportId(
            $request->getParam(
                "import_id"
            ),
