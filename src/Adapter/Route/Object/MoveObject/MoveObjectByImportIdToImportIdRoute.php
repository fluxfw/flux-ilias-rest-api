...
class MoveObjectByImportIdToImportIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Move object by import id to object by import id",
            null,
            [
    ...
    {
        $id = $this->ilias_rest_api->moveObjectByImportIdToImportId(
            $request->getParam(
                "import_id"
            ),
            $request->getParam(
