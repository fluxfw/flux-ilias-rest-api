...
class CloneObjectByIdToImportIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Clone object by id to object by import id",
            null,
            [
    ...
    {
        return "/object/by-id/{id}/clone/to-import-id/{parent_import_id}";
    }


    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        $id = $this->ilias_rest_api->cloneObjectByIdToImportId(
            $request->getParam(
                "id"
            ),
            $request->getParam(
