...
use FluxIliasRestApi\Libs\FluxIliasApi\Libs\FluxIliasBaseApi\Adapter\ScormLearningModule\ScormLearningModuleDto;
...
class GetScormLearningModuleByIdRoute implements Route
{
    ...
    {
        $scorm_learning_module = $this->ilias_api->getScormLearningModuleById(
            $request->getParam(
                "id"
            ),
            false
