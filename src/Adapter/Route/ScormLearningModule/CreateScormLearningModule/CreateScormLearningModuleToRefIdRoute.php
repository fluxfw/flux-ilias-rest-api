...
use FluxIliasRestApi\Libs\FluxIliasApi\Libs\FluxIliasBaseApi\Adapter\ScormLearningModule\ScormLearningModuleDiffDto;
...
class CreateScormLearningModuleToRefIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Create scorm learning module in object by ref id",
            null,
            [
    ...
    {
        return "/scorm-learning-module/create/to-ref-id/{parent_ref_id}";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_api->createScormLearningModuleToRefId(
            $request->getParam(
                "parent_ref_id"
            ),
