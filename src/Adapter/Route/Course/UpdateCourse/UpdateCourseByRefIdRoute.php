...
use FluxIliasRestApi\Libs\FluxIliasApi\Libs\FluxIliasBaseApi\Adapter\Course\CourseDiffDto;
...
class UpdateCourseByRefIdRoute implements Route
{
    ...
    {
        return "/course/by-ref-id/{ref_id}/update";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_api->updateCourseByRefId(
            $request->getParam(
                "ref_id"
            ),
