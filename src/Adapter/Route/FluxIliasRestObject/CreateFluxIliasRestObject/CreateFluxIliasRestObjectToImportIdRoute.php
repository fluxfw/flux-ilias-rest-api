...
use FluxIliasRestApi\Libs\FluxIliasApi\Libs\FluxIliasBaseApi\Adapter\FluxIliasRestObject\FluxIliasRestObjectDiffDto;
...
class CreateFluxIliasRestObjectToImportIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Create flux-ilias-rest-object in object by import id",
            null,
            [
    ...
    {
        return "/flux-ilias-rest-object/create/to-import-id/{parent_import_id}";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_api->createFluxIliasRestObjectToImportId(
            $request->getParam(
                "parent_import_id"
            ),
