...
class UpdateFluxIliasRestObjectByIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Update flux-ilias-rest-object by id",
            null,
            [
    ...
    {
        return "/flux-ilias-rest-object/by-id/{id}/update";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_api->updateFluxIliasRestObjectById(
            $request->getParam(
                "id"
            ),
