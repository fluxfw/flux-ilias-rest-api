...
class CreateOrganisationalUnitToExternalIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Create organisational unit in organisational unit by external id",
            null,
            [
                RouteParamDocumentationDto::new(
                    "parent_external_id",
                    "string",
                    "Parent organisational unit external id"
                )
            ],
            null,
            [
    ...
    {
        return "/organisational-unit/create/to-external-id/{parent_external_id}";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_rest_api->createOrganisationalUnitToExternalId(
            $request->getParam(
                "parent_external_id"
            ),
