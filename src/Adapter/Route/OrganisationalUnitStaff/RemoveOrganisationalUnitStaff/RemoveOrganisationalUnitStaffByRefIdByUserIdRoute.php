...
class RemoveOrganisationalUnitStaffByRefIdByUserIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Remove organisational unit staff by organisational unit ref id and user id",
            null,
            [
    ...
    {
        return "/organisational-unit/by-ref-id/{ref_id}/remove-staff/by-id/{user_id}/{position_id}";
    }


    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        $id = $this->ilias_rest_api->removeOrganisationalUnitStaffByRefIdByUserId(
            $request->getParam(
                "ref_id"
            ),
            $request->getParam(
