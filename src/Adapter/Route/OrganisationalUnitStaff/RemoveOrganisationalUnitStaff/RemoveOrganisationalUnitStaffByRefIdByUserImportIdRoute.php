...
class RemoveOrganisationalUnitStaffByRefIdByUserImportIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Remove organisational unit staff by organisational unit ref id and user import id",
            null,
            [
    ...
    {
        return "/organisational-unit/by-ref-id/{ref_id}/remove-staff/by-import-id/{user_import_id}/{position_id}";
    }


    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        $id = $this->ilias_rest_api->removeOrganisationalUnitStaffByRefIdByUserImportId(
            $request->getParam(
                "ref_id"
            ),
            $request->getParam(
