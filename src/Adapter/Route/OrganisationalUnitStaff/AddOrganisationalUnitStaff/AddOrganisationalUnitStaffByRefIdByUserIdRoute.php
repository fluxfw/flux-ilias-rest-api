...
class AddOrganisationalUnitStaffByRefIdByUserIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Add organisational unit staff by organisational unit ref id and user id",
            null,
            [
    ...
    {
        return "/organisational-unit/by-ref-id/{ref_id}/add-staff/by-id/{user_id}/{position_id}";
    }


    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        $id = $this->ilias_rest_api->addOrganisationalUnitStaffByRefIdByUserId(
            $request->getParam(
                "ref_id"
            ),
            $request->getParam(
