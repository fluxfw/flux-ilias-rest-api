...
class CreateCategoryToImportIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Create category in object by import id",
            null,
            [
    ...
    {
        return "/category/create/to-import-id/{parent_import_id}";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_rest_api->createCategoryToImportId(
            $request->getParam(
                "parent_import_id"
            ),
