...
use FluxIliasRestApi\Libs\FluxIliasApi\Libs\FluxIliasBaseApi\Adapter\Group\GroupDiffDto;
...
class UpdateGroupByRefIdRoute implements Route
{
    ...
    {
        return "/group/by-ref-id/{ref_id}/update";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_api->updateGroupByRefId(
            $request->getParam(
                "ref_id"
            ),
