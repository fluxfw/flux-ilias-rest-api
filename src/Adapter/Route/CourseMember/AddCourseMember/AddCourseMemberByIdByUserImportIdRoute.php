...
class AddCourseMemberByIdByUserImportIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Add course member by course id and user import id",
            null,
            [
    ...
    {
        return "/course/by-id/{id}/add-member/by-import-id/{user_import_id}";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_rest_api->addCourseMemberByIdByUserImportId(
            $request->getParam(
                "id"
            ),
            $request->getParam(
