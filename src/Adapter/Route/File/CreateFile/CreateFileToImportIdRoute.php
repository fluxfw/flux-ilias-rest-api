...
use FluxIliasRestApi\Libs\FluxIliasApi\Libs\FluxIliasBaseApi\Adapter\File\FileDiffDto;
...
class CreateFileToImportIdRoute implements Route
{
    ...
    public function getDocumentation() : ?RouteDocumentationDto
    {
        return RouteDocumentationDto::new(
            $this->getRoute(),
            $this->getMethod(),
            "Create file in object by import id",
            null,
            [
    ...
    {
        return "/file/create/to-import-id/{parent_import_id}";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_api->createFileToImportId(
            $request->getParam(
                "parent_import_id"
            ),
