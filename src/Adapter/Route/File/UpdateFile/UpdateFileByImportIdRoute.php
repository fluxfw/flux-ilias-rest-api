...
class UpdateFileByImportIdRoute implements Route
{
    ...
    {
        return "/file/by-import-id/{import_id}/update";
    }
    ...
    public function handle(ServerRequestDto $request) : ?ServerResponseDto
    {
        ...
        $id = $this->ilias_api->updateFileByImportId(
            $request->getParam(
                "import_id"
            ),
