...
RUN (mkdir -p /build/flux-ilias-rest-api/libs/flux-ilias-api && cd /build/flux-ilias-rest-api/libs/flux-ilias-api && wget -O - https://github.com/fluxfw/flux-ilias-api/releases/download/v2022-08-03-1/flux-ilias-api-v2022-08-03-1-build.tar.gz | tar -xz --strip-components=1 && /flux-namespace-changer/bin/change-namespace.php . FluxIliasApi FluxIliasRestApi\\Libs\\FluxIliasApi)
